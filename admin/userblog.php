...
if(!isset($_SESSION['id']))
{
  ...
  if(isset($_REQUEST['action']) && $_REQUEST['action']=="repo")
  {
    ...
    $query="select * from  user_post where id='$idk'";
      $req=mysqli_query($con,$query);
...
1px 1px 1px 1px #6f6f6f;
	...
	<body  class="bd">
		<div class="view" >
			<h3><a href="userdash.php"><abbr title="Back"><img src="photos/backbutton.png"></abbr></a>Blog From Register User</h3>
...
?>
   ...
   $sql_profile="select * from user_post where (blog_head like '%" . str_replace( ' ', '%\' AND blog_head LIKE \'%', $getresult ) . '%\') 
   ...
   // echo $sql_profile="select * from user_login where country LIKE '%$getresult%'";
    ...
    <tr>
      ...
      <td ><a href="userblog.php?action=del&id=<?php echo base64_encode($arr_profile['id'])?>" style="color: red">Delete</a><br><a href="userblog.php?action=repo&i=<?php echo base64_encode($arr_profile['id'])?>" style="color: #006C06FF">Report</a><br><a href="userblogview.php?id=<?php echo base64_encode($arr_profile['id'])?>">view</a></td>
    </tr>
  ...
  <table id="customers">
    ...
    <tr>
      ...
      <td><a href="userblog.php?action=del&id=<?php echo base64_encode($arr['id'])?>" style="color: red"><p>Delete</p></a><br><a href="userblog.php?action=repo&i=<?php echo base64_encode($arr['id'])?>" style="color: #006C06FF">Report</a><br><a href="userblogview.php?id=<?php echo base64_encode($arr['id'])?>"><p>view</p></a></td>
    </tr>
    <?php }?>
  </table>
</div>
