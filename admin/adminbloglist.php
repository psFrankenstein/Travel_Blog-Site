...
if(!isset($_SESSION['id']))
{
	...
	$query="select * from  user_post where blog_id=11 ORDER BY id DESC";
...
?>
   ...
   // echo $sql_profile="select * from user_login where country LIKE '%$getresult%'";
    ...
    <tr>
      ...
      <td ><a href="userblog.php?action=del&id=<?php echo base64_encode($arr_profile['id'])?>" style="color: red">Delete</a><br><a href="userblogview.php?id=<?php echo base64_encode($arr_profile['id'])?>">view</a><br><a href="updateblog.php?id=<?php echo base64_encode($arr_profile['id'])?>" style="color: green">Edit</a></td>
    </tr>
  ...
  <table id="customers">
    ...
    <tr>
      ...
      <td><a href="userblog.php?action=del&id=<?php echo base64_encode($arr['id'])?>" style="color: red"><p>Delete</p></a><br><a href="userblogview.php?id=<?php echo base64_encode($arr['id'])?>"><p>view</p></a><br><a href="updateblog.php?id=<?php echo base64_encode($arr['id'])?>" style="color: green">Edit</a></td>
    </tr>
    <?php }?>
  </table>
</div>
